                ...
                <Layout>
                    ...
                    <div className='w-full mt-5 grid grid-cols-1 lg:grid-cols-2 flex items-center gap-y-10 lg:gap-10'>
                        <div className='bg-green-400 group relative mb-4 h-auto'>
                            <a href='https://nysc-cds-e-attendance.com.ng/' target={"_blank"}>
                            ...
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <div className='text-gray-50 ml-2 mb-3 text-sm'>
                                        <a href='nysc-cds-e-attendance.com' target={"_blank"} className='hover:text-yellow-300 hover:underline mr-2'>Vist Site <i className="fa-solid fa-up-right-from-square"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='bg-black relative group md:mb-24 lg:mb-0 md:h-96'>
                            <a href='https://resaads.com.ng/' target={"_blank"}>
                            ...
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <div className='text-gray-50 ml-2 mb-3 text-sm'>
                                        <a href='https://resaads.com.ng/' target={"_blank"} className='hover:text-yellow-300 hover:underline mr-2'>Vist Site <i className="fa-solid fa-up-right-from-square"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='bg-yellow-600 relative group mb-4 h-auto'>
                            <a href='https://noajempire.com/' target={"_blank"}>
                            ...
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <div className='text-gray-50 ml-2 mb-3 text-sm'>
                                        <a href='https://noajempire.com/' target={"_blank"} className='hover:text-yellow-300 hover:underline mr-2'>Vist Site <i className="fa-solid fa-up-right-from-square"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='bg-blue-600 relative group mb-4 h-auto'>
                            <a href='https://donbekson.com/' target={"_blank"}>
                                <Image src={Donbekson} alt={"Noaj Empire - Ecommerce"} />
                            </a>
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <div className='text-gray-50 ml-2 mb-3 text-sm'>
                                        <a href='https://donbekson.com/' target={"_blank"} className='hover:text-yellow-300 hover:underline mr-2'>Vist Site <i className="fa-solid fa-up-right-from-square"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
