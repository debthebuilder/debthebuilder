export default function CircleNavigation() {
    return(
        <div className="w-screen h-screen flex items-center justify-center text-center relative">
            ...
            <div className="absolute group border-2 h-36 w-36 hover:cursor-pointer hover:bg-bl hover:h-56 hover:w-56 rounded-full flex items-center justify-center left-24">
