...
export default function CircleNavigation() {
    return(
        <div className="flex w-full h-full flex-row">
            <div className="w-1/3 relative group  h-screen flex items-center justify-center">
                <div className="absolute">
                    <Image src={Deb}  alt="Deb the Builder"  />
                </div>
                <div className="z-50">
                    <h2 className="group-hover:font-black group-hover:text-3xl group-hover:text-stone-50">Deb</h2></div>
            </div>
