    ...
    return(
        <div className="py-3">
            <nav className="w-full flex flex-col  md:flex-row items-center md:justify-between">
                <a href="/">
                    <div className="tracking-wider text-lg font-normal cursor-pointer text-gray-400 hover:text-gray-900 hover:font-semibold">Deb the Builder</div>
                </a>
                <ul className="flex w-full mt- md:w-1/2 flex-row justify-center items-center md:justify-end text-sm">
