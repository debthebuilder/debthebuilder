...
export default function Landing() {
    return(
        <div className="flex bg-stone-50 w-full h-full flex-col lg:flex-row overflow-hidden">
            <a href="/about" className="w-full lg:w-1/3">
                <div className=" relative group cursor-pointer  h-screen flex items-center justify-center">
            ...
            <a href="/portfolio" className="w-full lg:w-1/3"></a>
                <div className="w-full lg:w-1/3 relative group cursor-pointer h-screen flex items-center justify-center">
                    <div className="absolute">
            ...
            <a href="/learn" className="w-full lg:w-1/3">
                <div className="w-full lg:w-1/3 relative group cursor-pointer h-screen flex items-center justify-center">
                    <div className="absolute">
