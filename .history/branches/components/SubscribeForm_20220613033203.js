...
export default function SubscribeForm(){
    return(
        <>
        <div>
            <a href="https://gmail.us8.list-manage.com/subscribe/post?u=e8ad586d39179304b2aeb71c6&id=3d210216fb">
                <button className="outline-none py-1 x-2 border">Subscribe Mailing List</button>
            </a>
        </div>
            <div id="mc_embed_signup">
                <form action="https://gmail.us8.list-manage.com/subscribe/post?u=e8ad586d39179304b2aeb71c6&amp;id=3d210216fb" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" novalidate>
                    ...
                    <div className="mc-field-group flex items-center">
                        ...
                        <input type="email" value="" name="EMAIL" className="required email border py-1 px-2" id="mce-EMAIL" />
                    </div>
