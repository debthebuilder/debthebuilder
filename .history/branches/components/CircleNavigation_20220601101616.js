export default function CircleNavigation() {
    return(
        ...
        <div className="flex w-full h-full flex-row">
            ...
            <div className="w-1/3 reka bg-stone-100 h-screen flex items-center justify-center">
                <div>the <span>builder</span></div>
            </div>
            <div className="w-1/3 bg-stone-100 h-screen flex items-center justify-center">
