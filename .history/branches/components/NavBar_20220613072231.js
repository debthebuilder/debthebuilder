    ...
    return(
        <div className="py-3">
            <nav className="w-full flex flex-col  md:flex-row items-center md:justify-between">
                <a href="/">
                    <div className="tracking-wider text-lg font-normal cursor-pointer text-gray-400 hover:text-gray-900 hover:font-semibold">Deb the <span className="font-bold text-blue-">Builder</span></div>
                </a>
