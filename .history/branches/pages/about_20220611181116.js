                ...
                <Layout>
                    ...
                    <div>
                        ...
                        <div className='my-5'>
                            ...
                            <button className='inline-block cursor-pointer border py-1 px-2 tracking-widest mr-2 mb-2 hover:border-black hover:font-semibold hover:shadow-lg'>Download CV</button>
                        </div>
                    </div>
                </Layout>
            </main>
