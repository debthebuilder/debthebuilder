            ...
            <main>
                <Layout>
                    ...
                    <div className='w-full mt-5 grid grid-cols-1 lg:grid-cols-2 flex items-center gap-y-10 lg:gap-10'>
                        <div className='bg-green-400 group relative mb-4 h-auto'>
                            ...
                            <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                ...
                                <div className='text-gray-50 ml-2 mb-3 text-sm'>
                                    <a href='nysc-cds-e-attendance.com' className='hover:text-yellow-300 hover:underline mr-2'>Vist Site <i className="fa-solid fa-arrow-up-right-from-square"></i></a>
                                    <a href='/project' className='hover:text-yellow-300 hover:underline mr-2'>Read more...</a>
                                </div>
                            </div>
                            </div>
                        ...
                        <div className='bg-stone-100 group mb-4 h-auto'>
                            <a href='/'>
