                        ...
                        <div className='bg-red-400 group hover:border-4 hover:border-black h-96'>
                            ...
                            <div className='bg-white p-2 tracking-wider text-sm'>
                                ...
                                <div className=''>
                                    ...
                                    <span className='text-xs group-hover:border group-hover:border-black py-1 mt-3 hover:font-bold'>REACT js</span>
                                    <span className='text-xs group-hover:border group-hover:border-black py-1 mt-3 hover:font-bold ml-2'>Tailwind CSS</span>
                                    <span className='text-xs group-hover:border group-hover:border-black py-1 mt-3 hover:font-bold ml-2'>Express js</span>
                                    <span className='text-xs group-hover:border group-hover:border-black py-1 mt-3 hover:font-bold ml-2'>Express js</span>
