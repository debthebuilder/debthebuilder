                    ...
                    <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-10'>
                        <div className='bg-red-400 hover:border-4 hover:border-black h-96'>
                            ...
                            <div className='bg-white p-2 tracking-wider text-sm'>
                                ...
                                <div className='grid grid-cols-auto gap-3 my-3'>
                                    
                                        <span className='text-xs border border-black p-1 my-2 hover:font-bold'>REACT js</span>
                                        <span className='text-xs border border-black p-1 my-2 hover:font-bold ml-2'>Tailwind CSS</span>
