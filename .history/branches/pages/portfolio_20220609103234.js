                        ...
                        <div className='bg-red-400 group hover:border-4 hover:border-black h-96'>
                            ...
                            <div className='bg-white p-2 tracking-wider text-sm'>
                                ...
                                <div className=''>
                                    ...
                                    <span className='text-xs group-hover:border group-hover:border-black py-2 mt-3 hover:font-bold ml-2'>Axios</span>
                                    <span className='text-xs group-hover:border group-hover:border-black py-2 mt-3 hover:font-bold ml-2'>Formik</span>
