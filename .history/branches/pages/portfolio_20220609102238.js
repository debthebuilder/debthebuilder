                            ...
                            <div className='bg-white p-2 tracking-wider text-sm'>
                                ...
                                <div className='flex flex-col my-3'>
                                    <div>
                                        ...
                                        <span className='text-xs border border-black p-2 my-2 hover:font-bold ml-2'>Tailwind CSS</span>
                                        <span className='text-xs border border-black p-2 my-2 hover:font-bold ml-2'>Express js</span>
                                    </div>
                                </div>
