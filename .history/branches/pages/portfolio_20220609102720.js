                    ...
                    <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-10'>
                        <div className='bg-red-400 group hover:border-4 hover:border-black h-96'>
                            ...
                            <div className='bg-white p-2 tracking-wider text-sm'>
                                <div>
                                    <span className='group-hover:font-bold'>C.M.S for NYSC Community Development Service </span>
                                </div>
                                
                                <div className='my-3'>
                                    
                                        <span className='text-xs border border-black p-1 mt-3 hover:font-bold'>REACT js</span>
                                        <span className='text-xs border border-black p-1 mt-3 hover:font-bold ml-2'>Tailwind CSS</span>
