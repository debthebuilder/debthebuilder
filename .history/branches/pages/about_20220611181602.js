        ...
        <div>
            ...
            <main>
                <Layout>
                    ...
                    <div>
                        <div className='my-5'>
                            <h2 className='font-bold tracking-widest'>Hello, I am Deb...</h2>
                            <p className='font-normal'>a front-end developer currently transitioning to full-stack development with over 2 years of professional experience.  I also love creating solutions to problems in my community such as the <a href="/project" className='text-green-600 font-semibold hover:underline hover:font-bold'>C.M.S for NYSC CDS</a>. I am pretty much still getting started on my journey and I am enthusiastic about what the future holds, will you become part of my journey? I guess we will find out.  </p>
                        </div>
                        <div className='my-5'>
                        ...
                        <div className='my-5'>
                            <h2 className='font-bold tracking-widest mb-3'>Reach Out</h2>
                            <button className='inline-block cursor-pointer border py-1 px-2 tracking-widest mr-2 mb-2 hover:border-black hover:font-semibold'>Download CV</button>
                            <button className='inline-block cursor-pointer border py-1 px-2 tracking-widest mr-2 mb-2 hover:border-black hover:font-semibold'>Email Me</button>
                        </div>
                    </div>
                </Layout>
            </main>
