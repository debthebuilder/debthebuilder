        ...
        <div className='flex h-screen w-full items-center justify-center'>
          <div className='text-3xl font-semibold cursor-pointer  flex flex-row items-center'>
            <div className='flex flex-col group relative'>
              ...
              <div className='absolute hidden group-hover:block -top-24 md:top-0 md:-left-56 shadow max-w-sm h-12 bg-white w-44'>
                <div className='text-lg pl-5 py-3 text-yellow-300'>About Deb</div>
              </div>
            </div>
            <div className='flex flex-col ml-3 group relative'>
              ...
              <div className='absolute hidden group-hover:block -right-12 -top-24 md:-top-12 md:-right-56 shadow max-w-sm h-12 bg-white w-44'>
                <div className='text-lg pl-5 py-3 text-yellow-300'>Portfolio</div>
              </div>
              <div className='absolute hidden group-hover:block -right-12 -bottom-24  md:-right-56 shadow max-w-sm h-12 bg-white w-44'>
                <div className='text-lg pl-5 py-3 text-yellow-300'>Courses</div>
              </div>
            </div>
          </div>
        </div>
