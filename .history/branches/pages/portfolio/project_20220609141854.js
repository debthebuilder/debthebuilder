                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc ml-3'>
                            <li className='ml-2'>Record Attendance</li>
                            <li className='ml-2'>Record Monthly Dues Payments</li>
                            <li className='ml-2'>Record Event Dues Payments</li>
                            <li className='ml-2'>Record Project Dues Payments</li>
                            <li className='ml-2'>Record Meeting Minutes</li>
                            <li className='ml-2'>Create Quarterly Reports</li>
                            <li className='ml-2'>Collate Monthly Attendance Records</li>
                            <li className='ml-2'>View Members of Group </li>
                            <li className='ml-2'>View Weekly and Monthly Rettendance Records.</li>
                            <li className='ml-2'>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
