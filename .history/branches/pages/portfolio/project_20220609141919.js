                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc ml-5'>
                            <li className='hover:'>Record Attendance</li>
                            <li className='hover:'>Record Monthly Dues Payments</li>
                            <li className='hover:'>Record Event Dues Payments</li>
                            <li className='hover:'>Record Project Dues Payments</li>
                            <li className='hover:'>Record Meeting Minutes</li>
                            <li className='hover:'>Create Quarterly Reports</li>
                            <li className='hover:'>Collate Monthly Attendance Records</li>
                            <li className='hover:'>View Members of Group </li>
                            <li className='hover:'>View Weekly and Monthly Rettendance Records.</li>
                            <li className='hover:'>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
