                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc'>
                            <li className=''>Record Attendance</li>
                            <li className=''>Record Monthly Dues Payments</li>
                            <li className=''>Record Event Dues Payments</li>
                            <li className=''>Record Project Dues Payments</li>
                            <li className=''>Record Meeting Minutes</li>
                            <li className=''>Create Quarterly Reports</li>
                            <li className=''>Collate Monthly Attendance Records</li>
                            <li className=''>View Members of Group </li>
                            <li className=''>View Weekly and Monthly Rettendance Records.</li>
                            <li className=''>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
