                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc'>
                            <li className='ml-1'>Record Attendance</li>
                            <li className='ml-1'>Record Monthly Dues Payments</li>
                            <li className='ml-1'>Record Event Dues Payments</li>
                            <li className='ml-1'>Record Project Dues Payments</li>
                            <li className='ml-1'>Record Meeting Minutes</li>
                            <li className='ml-1'>Create Quarterly Reports</li>
                            <li className='ml-1'>Collate Monthly Attendance Records</li>
                            <li className='ml-1'>View Members of Group </li>
                            <li className='ml-1'>View Weekly and Monthly Rettendance Records.</li>
                            <li className='ml-1'>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
