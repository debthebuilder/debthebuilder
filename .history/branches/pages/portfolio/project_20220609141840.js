                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc'>
                            <li className='ml-'>Record Attendance</li>
                            <li className='ml-'>Record Monthly Dues Payments</li>
                            <li className='ml-'>Record Event Dues Payments</li>
                            <li className='ml-'>Record Project Dues Payments</li>
                            <li className='ml-'>Record Meeting Minutes</li>
                            <li className='ml-'>Create Quarterly Reports</li>
                            <li className='ml-'>Collate Monthly Attendance Records</li>
                            <li className='ml-'>View Members of Group </li>
                            <li className='ml-'>View Weekly and Monthly Rettendance Records.</li>
                            <li className='ml-'>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
