                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc'>
                            ...
                            <li>Record Monthly Dues Payments</li>
                            <li>Record Event Dues Payments</li>
                            <li>Record Project Dues Payments</li>
                            <li>Record Meeting Minutes</li>
                            <li>Create Quarterly Reports</li>
                            <li>Collate Monthly Attendance Records</li>
                            <li>View Members of Group </li>
                            <li>View Weekly and Monthly Rettendance Records.</li>
                            <li>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
