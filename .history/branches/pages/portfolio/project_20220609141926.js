                ...
                <Layout>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc ml-5'>
                            <li className='hover:text-green-5'>Record Attendance</li>
                            <li className='hover:text-green-5'>Record Monthly Dues Payments</li>
                            <li className='hover:text-green-5'>Record Event Dues Payments</li>
                            <li className='hover:text-green-5'>Record Project Dues Payments</li>
                            <li className='hover:text-green-5'>Record Meeting Minutes</li>
                            <li className='hover:text-green-5'>Create Quarterly Reports</li>
                            <li className='hover:text-green-5'>Collate Monthly Attendance Records</li>
                            <li className='hover:text-green-5'>View Members of Group </li>
                            <li className='hover:text-green-5'>View Weekly and Monthly Rettendance Records.</li>
                            <li className='hover:text-green-5'>Members can only view their own Attendance record, Monthly, Event, and Project Dues.</li>
                        </ul>
                    </div>
