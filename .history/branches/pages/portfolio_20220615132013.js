            ...
            <main>
                <Layout>
                    ...
                    <div className='w-full mt-5 grid grid-cols-1 lg:grid-cols-2 flex items-center gap-y-10 lg:gap-10'>
                        <div className='bg-green-400 group relative mb-4 h-auto'>
                            ...
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <ul className='flex flex-wrap flex-row text-sm lg:text-base items-center ml-2 my-3'>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>React Js</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Tailwind CSS</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Font Awesome Icons</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Multer</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>JSON Web Token</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Express Js</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>MySQL</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Node js</li>
                        ...
                        <div className='bg-black group md:mb-24 lg:mb-0 md:h-96'>
                            ...
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <ul className='flex flex-wrap flex-row text-sm lg:text-base items-center ml-2 my-3'>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>WordPress</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>WooCommerce</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Google Analytics</li>                                    </ul>
                                    <div className='text-gray-50 ml-2 mb-3 text-sm'>
                                        <a href='nysc-cds-e-attendance.com' className='hover:text-yellow-300 hover:underline mr-2'>Vist Site <i className="fa-solid fa-up-right-from-square"></i></a>
                                    </div>
                                </div>
                        ...
                        <div className='bg-yellow-600 group mb-4 h-auto'>
                            ...
                            <div className='hidden group-hover:inline-block'>
                                <div className=' w-full h-full bg-black bg-opacity-80 flex flex-col justify-end absolute left-0 top-0 z-50 '>
                                    ...
                                    <ul className='flex flex-wrap flex-row text-sm lg:text-base items-center ml-2 my-3'>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>WordPress</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>WooCommerce</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Google Analytics</li>
                                        <li className='inline-block border text-gray-50 hover:font-bold py-1 px-2 mb-3 mr-2 '>Font Awesome Icons</li>
                                    </ul>
                                    <div className='text-gray-50 ml-2 mb-3 text-sm'>
