        ...
        <div>
            ...
            <main>
                <Layout>
                    ...
                    <div className='w-full grid grid-cols-1 lg:grid-cols-2 gap-y-10 lg:gap-10'>
                        <div className='bg-green-400 group hover:border-4 hover:border-black h-auto max-h-96'>
