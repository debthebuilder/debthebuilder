            ...
            <main>
                <Layout>
                    ...
                    <div className='w-full grid grid-cols-1 lg:grid-cols-2 flex items-center gap-y-10 lg:gap-10'>
                        <div className='bg-green-400 group hover:border-4 hover:border-black mb-4 h-auto'>
                            <a href='/portfolio/project'>
                                <Image src={NYSCSplash} alt={"CMS FOR NYSC CDS Group"} />
                            </a>
                        </div>
                        <div className='bg-black group hover:border-4 hover:border-black mb-4 md:h-96'>
                            <a href='/portfolio/project'>
                                <Image src={Resaads} alt={"CMS FOR NYSC CDS Group"} />
                            </a>
                        </div>
                        <div className='bg-yellow-600 group hover:border-4 hover:border-black h-auto'>
                            <a href='/portfolio/project'>
