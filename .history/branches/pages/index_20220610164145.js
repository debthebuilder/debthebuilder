        ...
        <div className='flex h-screen w-full items-center justify-center'>
          <div className='text-3xl font-semibold cursor-pointer  flex flex-row items-center'>
            <div className='flex flex-col group relative'>
              ...
              <div className='absolute hidden group-hover:block -left-56 shadow max-w-sm h-12 bg-white w-44'>
            ...
            <div className='flex flex-col ml-3 group relative'>
              ...
              <span className='border-b-0 group-hover:border-b-2 w-full'></span>
              <div className='absolute hidden group-hover:block -top-24 -right-56 shadow max-w-sm h-12 bg-white w-44'>
