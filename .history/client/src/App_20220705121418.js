...
function App() {
  return (
    <div className='bg-white w-full p-5'>
      <div className='border-4 border-r-20 border-black mt-10 bg-purple-500 -skew-3 transform-gpu'>
      ...
      <div className='flex flex-col md:flex-row md:items-center my-10'>
          <div className='h-64 w-8/12 bg-yellow-500 mr-10 border-4 border-t-5 border-black'></div>
          <div className='h-64 w-4/12 bg-blue-500 border border-l-8'>
            
          </div>
      </div>
      <div className='flex flex-col md:flex-row md:items-center my-10'>
          <div className='h-96 w-9/12 bg-yellow-500 mr-10 border-4 border-t-5 border-black'></div>
          <div className='h-64 w-3/12 bg-blue-500 border border-l-8'>
