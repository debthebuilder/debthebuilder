...
function App() {
  return (
    <div className='bg-white w-full p-5'>
      ...
      <div className='flex flex-col md:flex-row md:items-center mt-10'>
          <div className='h-96 w-full md:w-9/12 bg-green-500 mr-10 border-4 border-t-5 border-black'></div>
          <div className='w-full md:w-3/12 bg-blue-500 border border-l-8'>
