  ...
  return (
    <div className='bg-white w-full p-5'>
      ...
      <div className='flex flex-col md:flex-row md:items-center mt-10'>
          <div className='md:h-64 w-full md:w-8/12 bg-yellow-500 md:mr-10 border-4 border-t-5 border-black'>
          <div className='pl-10 py-10'>
            ...
            <ul className='flex w-full flex-wrap flex-row items-center font-semibold text-sm tracking-wider mt-5'>
          ...
          <div className='h-64 w-full md:w-4/12 bg-blue-500 mt-10 md:mt-0 border-4 border-black '></div>
      </div>
      <div className='flex flex-col md:flex-row md:items-center mt-10'>
