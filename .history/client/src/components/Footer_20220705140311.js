        ...
        <div className='border-4 border-black my-10 bg-blue-500 py-10'>
            <div className='flex flex-col md:flex-row md:items-center tracking-wider'>
                ...
                <ul className='px-10 mt-5 md:mt-0 w-full md:w-4/6 flex flex-row items-center justify-between'>
                  ...
                  <li className='flex flex-col hover:text-white hover:font-semibold group'><a href='mailto:hello@debthebuilder.com'><i class="fa-brands fa-telegram"></i> telegram</a><span className='hidden border-2 border-white mt-1 group-hover:block'></span></li>
