...
const About = () => {
    return(
        <div className='flex flex-col md:flex-row md:items-center mt-10 tracking-wider'>
            <div className='h-auto w-full md:w-8/12 bg-yellow-400 md:mr-10 border-4  border-black dark:border-white'>
            ...
            <div className='h-auto w-full md:w-4/12 bg-blue-500 mt-10 md:mt-0 border-4 border-black dark:border-white p-5'>
