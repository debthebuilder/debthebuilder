...
const About = () => {
    return(
        <div className='flex flex-col lg:flex-row lg:items-center mt-10 tracking-wider'>
            <div className='h-auto w-full lg:w-8/12 bg-yellow-400 lg:mr-10 border-4  border-black dark:border-white'>
                <div className='pl-10 py-10'>
                    ...
                    <span className='mt-3'>with full-stack experience <br/> Located in <span className='text-white font-semibold'>Enugu</span></span>
                    <ul className='flex w-full flex-wrap flex-row items-center  text-sm tracking-wider font-medium mt-5 list-disc'>
                        ...
                        <li className='mr-7'>Rest Apis</li>
                        <li className='mr-7'>Git</li>
                        <li className='mr-7'>Github</li>
                        <li className='mr-7'>WordPress</li>
                    </ul>
                    <ul className="flex flex-row items-center text-sm tracking-wider justify-start mt-3 text-blue-700">
            ...
            <div className='h-auto w-full lg:w-4/12 bg-blue-500 mt-10 lg:mt-0 border-4 border-black dark:border-white p-5'>
                <h2 className="text-3xl font-bold">the <span className="text-white tracking-wider">Journey</span> so far...</h2>
                ...
                <div>
                    <a href={require("../DebtheBuilder_Resume.pdf")} download="debthebuilderResume">
