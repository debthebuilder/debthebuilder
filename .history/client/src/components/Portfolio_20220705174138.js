    ...
    return(
        <div className='flex flex-col md:flex-row md:items-center mt-10'>
            ...
            <div className='w-full md:w-3/12 mt-10 md:mt-0'>
                <div className='w-full h-auto  border-4 border-black dark:border-blue-500 cursor-pointer'>
                ...
                <div className='w-full h-auto bg-amber-400 mt-10 border-4 dark:border-blue-500 border-black cursor-pointer'>
