    ...
    return(
        <div className='flex flex-col md:flex-row md:items-center mt-10'>
            <div className='w-full md:w-1/4 bg-purple-500 h-56 border-4 border-black'>
                <div className="flex flex-col items-center justify-center h-full tracking-wider group">
                    ...
                    <div className="text-gray-200">
                        <span className="text-sm tracking-widest mr-1">#beginner</span>
                        <span className="text-sm tracking-widest mr-1">#online</span>
                        <span className="text-sm tracking-widest mr-1">#interactive</span>
                    </div>
                    <h3 className="font-semibold">HTML + CSS + Boot</h3>
