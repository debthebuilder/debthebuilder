const About = () => {
    return(
        <div className='flex flex-col md:flex-row md:items-center mt-10'>
            ...
            <div className='h-64 w-full md:w-4/12 bg-blue-500 mt-10 md:mt-0 border-4 border-black '>
                <h2 className="text-3xl font-bold mx-5">the <span className="text-white">Journey</span> so far...</h2>
            </div>
        </div>
    )
}
