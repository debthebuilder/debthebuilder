...
export const Navbar = () => {
    return(
        <div className="fixed w-full left-0 px-5 bg-transparent z-20">
            <nav className="flex flex-row items-center py-10 justify-between px-5 shadow">
                <Link to={"/"}>
                    <span className="font-semibold hover:font-bold bg-gray-50">Deb the Builder</span>
                </Link>
