            ...
            <div className='md:h-64 w-full md:w-8/12 bg-yellow-400 md:mr-10 border-4 border-t-5 border-black'>
                <div className='pl-10 py-10'>
                    ...
                    <ul>
                        ...
                        <li className='flex flex-col hover:text-white hover:font-semibold group'><a href='https://profile.codersrank.io/user/latenightsnacc'><i className="fa-brands fa-github"></i>  codersrank</a><span className='hidden border-2 border-white mt-1 group-hover:block'></span></li>
                        <span>
                            <a href="https://profile.codersrank.io/user/latenightsnacc" rel="noreferrer" target={"_blank"}>codersrank</a></span>
                    </ul>
                </div>
            </div>
