            ...
            <div className='h-auto w-full md:w-8/12 bg-yellow-400 md:mr-10 border-4 border-t-5 border-black'>
                <div className='pl-10 py-10'>
                    ...
                    <ul className="flex flex-row items-center text-sm tracking-wider justify-start mt-3">
                        <li className='flex flex-col hover:text-white hover:font-semibold group ml-5'><a href='https://github.com/debthebuilder'><i className="fa-brands fa-github"></i>  github</a><span className='hidden border-2 border-white mt-1 group-hover:block'></span></li>
